...
class FinanceViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun createLoanCycle(
        ...
        viewModelScope.launch {
            ...
            if (customer != null && customer.smsConfirmationOfEntry) {
                ...
                triggerNewLoanSms(appCtx, customer, dummyLoan)
            }
            createOrUpdateCustomerFiles(customerId)
            markDirty()
        }
    ...
    fun triggerManualReminderSms(customer: Customer, loan: LoanCycle) {
        val appCtx = getApplication<Application>()
    ...
    fun triggerWhatsappReminder(customer: Customer, loan: LoanCycle) {
        val appCtx = getApplication<Application>()
